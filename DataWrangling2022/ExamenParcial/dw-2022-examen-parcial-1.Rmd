...
El '==' es utilizado para comparación, por ejemplo en un if. Mientras que '=' es utilizado para asignar valores a una variable, objeto, etc.
...
Se utiliza having para filtrar data agrupada, porque where solo puede filtrar filas normales no agrupadas
